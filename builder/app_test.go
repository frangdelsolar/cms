...
// TestJsonifyInterface tests that JsonifyInterface correctly converts a struct to a map[string]interface{}, including the use of "omitempty" tags.
func TestJsonifyInterface(t *testing.T) {
	...
	data := builder.JsonifyInterface(&testStruct)
